  ...
  <el-main>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button type="primary" icon="el-icon-plus" @click="addBtn">新增租户</el-button>
      </el-form-item>
    </el-form>
    ...
    >
      <template slot="content">
        <el-form
          ...
          size="small"
        >
          <el-form-item prop="id" label="租户名称">
...
export default {
  ...
  methods: {
    ...
    async deleteBtn(row) {
      console.log(row)
      // 信息确认提示
      const confirm = await this.myconfirm("确定删除该租户吗?")
      console.log(confirm)
      if (confirm) {
