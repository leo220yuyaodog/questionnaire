  ...
  <div>
    <el-card class="box-card" shadow="hover">
      ...
      <div v-if="questionType === 'date' || questionType === 'single_line_text' || questionType === 'multi_line_text'">
        <el-table :data="writeValueList" height="250" border style="width: 80%; margin: auto">
          <el-table-column prop="writeValue" label="填写内容"> </el-table-column>
        </el-table>
      </div>
...
export default {
  ...
  methods: {
    fetchData() {
      if (
        this.questionType === 'single_check' ||
        this.questionType === 'multi_check' ||
        this.questionType === 'number' ||
        this.questionType === 'grade'
      ) {
        this.axios
          .get('/api/getQuestionValueList', {
            params: {
