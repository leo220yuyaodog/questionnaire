  ...
  <div>
    <div class="main-question-list">
      ...
      <el-card>
        ...
        <el-dialog v-model:visible="releaseVisible" width="30%" title="发布成功" append-to-body center>
          问卷链接为：
          <el-link
            class="copy-link"
            target="_blank"
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      this.axios
        .get('/api/getQuestionnaireOutline', {
          params: {
            questionnaireId: this.$route.params.id,
          },
        })
    ...
    saveOneQuestion(data) {
      ...
      this.axios
        .post(`/api/saveOneQuestion?questionnaireId=${this.$route.params.id}`, {
    ...
    saveQuestionnaireTitle() {
      ...
      this.axios
        .post('/api/saveQuestionnaireOutline', {
    ...
    deleteQuestionnaire() {
      ...
      this.axios
        .get('/api/deleteQuestionnaire', { params: { questionnaireId: this.questionnaire.questionnaireId } })
        .then((response) => {
    ...
    releaseQuestionnaire() {
      this.axios
        .post(`/api/releaseQuestionnaire?questionnaireId=${this.$route.params.id}`)
        .then(() => {
