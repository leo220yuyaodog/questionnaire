<template>
  <div style="position: relative">
    <el-card class="box-card" shadow="hover" :body-style="{ padding: '0' }">
      <div v-if="!isBoxSelected" class="box-is-not-selected-wrapper" @click="clickUnSelected">
        <div class="box-is-not-selected">
          <div class="question-title-div">
            ...
            <div v-if="questionNullableValue === false" style="display: inline" class="nullable-star">*</div>
          </div>
          ...
          <el-input
            v-else-if="typeValue === 'single_line_text'"
            type="text"
            style="max-width: 80%"
          ...
          <el-input
            v-else-if="typeValue === 'multi_line_text'"
            type="textarea"
            style="max-width: 80%"
          ...
          <div v-if="frontChoose">
            ...
            <div v-for="(item, index) in frontOptionsValue" :key="index">
              前置选项{{ index + 1 }}：
              <el-cascader :value="item" :options="frontOptions" :disabled="true"></el-cascader>
            </div>
          </div>
        </div>
      ...
      <div v-if="isBoxSelected" class="box-is-selected">
        ...
        <el-form>
          ...
          <div v-if="frontChooseValue === true">
            <el-form-item
              v-for="(item, index) in frontOptionsValue"
              :key="index"
              :label="'前置选项' + (index + 1) + '：'"
            >
              <div class="block">
              ...
              <el-tooltip effect="light" content="在下方添加" :open-delay="200" :hide-after="1500" placement="top">
                <el-button size="medium" round class="add-option-button" @click="addFrontOption"
                  ><i class="el-icon-plus"></i>
                </el-button>
              </el-tooltip>
              <el-tooltip effect="light" content="删除本选项" :open-delay="200" :hide-after="1500" placement="top">
                <el-button size="medium" round class="delete-option-button" @click="deleteFrontOption(index)"
          ...
          <div v-if="typeValue === 'single_check' || typeValue === 'multi_check'">
            <el-form-item v-for="(item, index) in optionsValue" :key="index">
              ...
              <el-tooltip effect="light" content="在下方添加" :open-delay="200" :hide-after="1500" placement="top">
                <el-button size="medium" round class="add-option-button" @click="addOption"
                  ><i class="el-icon-plus"></i>
                </el-button>
              </el-tooltip>
              <el-tooltip effect="light" content="删除本选项" :open-delay="200" :hide-after="1500" placement="top">
                <el-button size="medium" round class="delete-option-button" @click="deleteOption(index)"
                  ><i class="el-icon-delete"></i>
                </el-button>
              </el-tooltip>
            </el-form-item>
